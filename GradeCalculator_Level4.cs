...
namespace GradeCalculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.Write("How many points did you scored(0-20)? ");
            ...
            if (decision == "Yes" || decision == "yes")
            {
                ...
                oralPoints = Convert.ToInt32(Console.ReadLine()!);
                possiblePoints += 20;
            }
            else { possiblePoints -= 20; }


            procentResult = 100d * (firstTest + secondTest + homeworkPoints + oralPoints) / possiblePoints;
            ...
            {
                procentResultTwo = 100d * (firstTest + secondTest + possibleHomeworkPoints + oralPoints) / possiblePoints;
